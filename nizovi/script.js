...
// // // let dati = parseInt(prompt("Unesite zeljeni br:"));

// // // let result = finder(main,dati)


// // // if(result){
// // //     console.log(`postoji zbir ta dva broja`);
// // // }
// // // else{`ne postoji`}

// // // 11.1>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>.

// // let brojRedova = parseInt(prompt("Unesite željeni broj redova: "));
// // let brojKolona = parseInt(prompt("Unesite željeni broj kolona: "));
// // var matrica = [];

// // for (let i = 0; i < brojRedova; i++) {
// //   let red = [];
// //   for (let j = 0; j < brojKolona; j++) {
// //     let broj = parseFloat(prompt(`Unesite broj za red ${i + 1} i kolonu ${j + 1}:`));
// //     red.push(broj);
// //   }
// //   matrica.push(red);
// // }
...
// //     for (var k = 0; k < matrica[j].length; k++) {
// //       console.log(matrica[j][k]);
// //     }
// //   }
...
//     console.log(`u ovoj  matrici ima ${brojac} nule`);
