...
// let novibroj = parseInt(prompt("Unesi novi broj"));

// for(let i = 0; i < niz1.length; i++){
//     if(niz1[i]> novibroj){
//         niz1.splice(i, 0, novibroj)
//         break;
//     }
// }
...
// let brojElemenata1 = parseInt(prompt("Unesite broj elemenata"));
// let niz2 = [];

// for (let i = 0; i < brojElemenata1; i++) {
//   let broj1 = parseFloat(prompt("Unesite broj"));
//   niz2.push(broj1);
  
// }

// let all = niz1.concat(niz2).sort((a,b) => a-b)
